...
export const AppDataSource = new DataSource({
    ...
    synchronize: true,
    logging: true,
    entities: [User, Workspace, WorkspaceMember, Notification, List, Comment, Card, CardMember, Board, BoardMember, Role, Permission, RolePermission, Otp, WorkspaceJoinLink],
