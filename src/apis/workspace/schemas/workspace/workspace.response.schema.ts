...
import { WorkspaceMemberResponseSchema } from '../workspace-member/workspace-member.response.schema';
...
export const WorkspaceResponseSchema = z.object({
    ...
    workspaceMembers: z.array(WorkspaceMemberResponseSchema).optional(),
    ownerId: z.uuid().openapi({ example: '123e4567-e89b-12d3-a456-426614174000' }),
    // set boardMembers to optional here
    created_at: z.date(),
    updated_at: z.date()
})
